...
def parse_args():
    ...
    parser.add_argument('--google_search_engine_id', type=str, default='')
    ...
    parser.add_argument('--naver_client_id', type=str, default='')
    parser.add_argument('--naver_client_secret', type=str, default='')
    parser.add_argument('--naver_display', type=int, default=20)
    
    parser.add_argument('--openai_api_key', type=str, default='sk-')
